...
class GrammaticThemeScreen extends Component {
  ...
  getGrammarTaskById() {
    ...
    Api.fetchData(
      Config.DOMAIN + '?action=getGrammarTaskById',
      formData,
  ...
  render() {
    ...
    const {theme, progress} = this.state;
    ...
    return progress ? (
      ...
      <View style={styles.main}>
        ...
        {state.params.difficult > 0 ? (
          <AppButton
            style={styles.btnTrain}
            value="Тренировать"
            fontColor="white"
            underlayColor="#4CAF50"
            onPress={() => this.startPractic(theme)}
          />
        ) : null}
      </View>
    );
...
export default GrammaticThemeScreen;
